...
\begin{figure}[h!] % [h!]
   \includegraphics[width=\linewidth]{img/EntidadRelacion.png}
...
\begin{figure}[h!] % [h!]
 ...
 \begin{figure}[h!] % [h!]
  \includegraphics[width=0.32\textwidth]{img/Vista_Calendario_MVL.png}
  \caption{Mockup vista calendario movil}
  \label{fig:calendarioMVL}
\end{figure}

 \begin{figure}[h!] % [h!]
   \includegraphics[width=0.32\textwidth]{img/Vista_Opciones_MVL.png}
   \caption{Mockup vista opciones movil}
   \label{fig:opcionesMVL}
 \end{figure}

 \begin{figure}[h!] % [h!]
   \includegraphics[width=0.32\textwidth]{img/Vista_Informes_MVL.png}
   \caption{Mockup vista informes movil}
   \label{fig:informesMVL}
 \end{figure}

 \begin{figure}[h!] % [h!]
   \includegraphics[width=0.64\textwidth]{img/Vista_Administracion_PC.png}
   \caption{Mockup vista administracion pc}
   \label{fig:administracionPC}
 \end{figure}

 \begin{figure}[h!] % [h!]
   \includegraphics[width=0.32\textwidth]{img/Vista_Administracion_MVL.png}
...
Para el acceso a la api, se ha usado axios, que es el módulo que recomienda Quasar para las peticiones Ajax.
