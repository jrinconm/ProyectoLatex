...
También debería poder visualizar todos los días trabajados, y obtener distintos tipos de informes de ella.
...
\begin{figure}[h!] % [h!]
  \centering
   \includegraphics[width=0.80\textwidth]{img/calendarioSonarqube.png}
