...
El despliegue se ha realizado mediante docker-compose en una instancia de Google Cloud, expuesto a internet en la siguiente dirección:
\url{http://jrincon.eu}.
...
\begin{figure}[h!] % [h!]
  \centering
   \includegraphics[scale=0.80]{img/cargas de trabajo.png}
 ...
 \begin{figure}[h!] % [h!]
  \centering
   \includegraphics[scale=0.80]{img/cargaGoogleCloud.png}
...
\begin{figure}[h!] % [h!]
  \centering
   \includegraphics[scale=0.80]{img/ipexterna.png}
...
\begin{figure}[h!] % [h!]
  \centering
   \includegraphics[scale=0.80]{img/estadosonar.png}
...
\begin{figure}[h!] % [h!]
  \centering
   \includegraphics[scale=0.80]{img/calendarioSonarqube.png}
