...
\begin{figure}
   \includegraphics[width=\linewidth]{img/Clases sequelize.png}[h!] % [h!]
...
\begin{figure}
   \includegraphics[width=\linewidth]{img/EsquemaBBDD.png}[h!] % [h!]
...
\begin{figure}
   \includegraphics[width=\linewidth]{img/Vista_Calendario_PC.png}[h!] % [h!]
   \caption{Mockup vista calendario pc}
   \label{fig:calendarioPC}
 \end{figure}

 \begin{figure}
   \includegraphics[width=\linewidth]{img/Vista_Calendario_MVL.png}[h!] % [h!]
   \caption{Mockup vista calendario movil}
   \label{fig:calendarioMVL}
 \end{figure}

 \begin{figure}
   \includegraphics[width=\linewidth]{img/Vista_Opciones_PC.png}[h!] % [h!]
   \caption{Mockup vista opciones pc}
   \label{fig:opcionesPC}
 \end{figure}

 \begin{figure}
   \includegraphics[width=\linewidth]{img/Vista_Opciones_MVL.png}[h!] % [h!]
   \caption{Mockup vista opciones movil}
   \label{fig:opcionesMVL}
 \end{figure}

 \begin{figure}
   \includegraphics[width=\linewidth]{img/Vista_Informes_PC.png}[h!] % [h!]
   \caption{Mockup vista informes pc}
   \label{fig:informesPC}
 \end{figure}

 \begin{figure}
   \includegraphics[width=\linewidth]{img/Vista_Informes_MVL.png}[h!] % [h!]
   \caption{Mockup vista informes movil}
   \label{fig:informesMVL}
 \end{figure}

 \begin{figure}
   \includegraphics[width=\linewidth]{img/Vista_Administracion_PC.png}[h!] % [h!]
   \caption{Mockup vista administracion pc}
   \label{fig:administracionPC}
 \end{figure}

 \begin{figure}
   \includegraphics[width=\linewidth]{img/Vista_Administracion_MVL.png}[h!] % [h!]
