...
\begin{figure}[h!] % [h!]
  \centering
   \includegraphics[scale=0.60]{img/EntidadRelacion.png}
 ...
 \begin{figure}[h!] % [h!]
  \centering
   \includegraphics[scale=0.60]{img/DiagramaERFinal.png}
   \caption{Diagrama E/R}
...
Se ha usado \LaTeX{} para crear la documentación, que está formado por un gran conjunto de macros de TeX, siendo un lenguaje de marcas. Se Ha elegido \LaTeX{} frente a Word o LibreOffice, ya que se conocía el lenguaje con anterioridad, permite automáticamente colorear el código, y la presentación parece más profesional.
