...
Se ha creado un microservicio en un contenedor docker basado en node.js , usando el framework xpress, para comunicar con la base de datos mariadb a través del ORM Sequelize. 
...
Google cloud es uno de los servidores donde podemos desplegarlo, con las posibilidades con aplicación móvil y sin ella, así como en un servidor dedicado.
...
\begin{figure}[!htb]
   ...
   \endminipage\hfill
   \minipage{0.32\textwidth}
     \includegraphics[width=\linewidth]{img/Node.js_logo.svg}
