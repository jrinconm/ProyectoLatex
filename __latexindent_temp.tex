...
\begin{figure}[h!] % [h!]
  \centering
   \includegraphics[scale=0.70]{img/EntidadRelacion.png}
...
Se ha usado la librería QCalendar de Quasar, que dota de funciones de fecha/hora, así como un interfaz de calendario mensual, semanal y diario.
